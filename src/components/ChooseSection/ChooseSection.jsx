  ...
  return (
    <div>
      <div className="container">
        <h2 className='text-center mb-5'>Why Choose Sri University?</h2>
        <div className='row g-4'>
            ...
            <Card className='d-flex align-items-center border-0 h-100'>
              ...
              <Card.Body>
                <Card.Title className='text-center text-capitalize mb-3'>
                  2 Prestigious Trophies
                </Card.Title>
                <Card.Text className='text-center'>
                  Sri University has been recognized with multiple awards for excellence in academics and research, showcasing our commitment to quality education.
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
          ...
          <div className='col-lg-4'>
            <Card className='d-flex align-items-center border-0 h-100'>
              ...
              <Card.Body>
                ...
                <Card.Text className='text-center'>
                  We ensure a positive and supportive learning environment, keeping our students engaged, motivated, and ready to achieve their dreams.
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
          ...
          <div className='col-lg-4'>
            <Card className='d-flex align-items-center border-0 h-100'>
              ...
              <Card.Body>
                <Card.Title className='text-center text-capitalize mb-3'>
                  3 Campuses Across the UK
                </Card.Title>
                <Card.Text className='text-center'>
                  Sri University offers its programs in three vibrant locations, providing students with diverse cultural experiences and academic opportunities.
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
